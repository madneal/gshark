...
type Rule struct {
	...
	MatchPattern   string `json:"matchPattern" form:"matchPattern" gorm:"column:match_pattern;type:varchar(200);size:200;"`
	ValidationType string `json:"validationType" form:"validationType" gorm:"column:validation_type;type:varchar(32);size:32;"`
}
