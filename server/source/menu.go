...
var menus = []model.SysBaseMenu{
	...
	{GVA_MODEL: global.GVA_MODEL{CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "24", Path: "task", Name: "task", Hidden: false, Component: "view/task/task.vue", Sort: 4, Meta: model.Meta{Title: "任务管理", Icon: "s-flag"}},
}
