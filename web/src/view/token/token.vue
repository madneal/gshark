<template>
  <div>
    ...
    <el-table-column label="token" prop="content" width="120"></el-table-column> 
    ...
    <el-table-column label="remaining" prop="remaining" width="120"></el-table-column> 
    
    <el-table-column label="重置时间" prop="resetTime" width="120"></el-table-column> 
    
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button class="table-button" @click="updateToken(scope.row)" size="small" type="primary" icon="el-icon-edit">变更</el-button>
