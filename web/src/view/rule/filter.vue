<template>
  <div>
    ...
    <el-table-column label="文件后缀" prop="extension" width="120"></el-table-column> 
    
    <el-table-column label="是否fork" prop="isFork" width="120">
         <template slot-scope="scope">{{scope.row.isFork|formatBoolean}}</template>
    </el-table-column>
    
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button class="table-button" @click="updateFilter(scope.row)" size="small" type="primary" icon="el-icon-edit">变更</el-button>
...
export default {
  ...
  methods: {
      ...
      onSubmit() {
        this.page = 1
        this.pageSize = 10       
        if (this.searchInfo.isFork==""){
          this.searchInfo.isFork=null
        }      
        this.getTableData()
      },
